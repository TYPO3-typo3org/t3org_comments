...
$TYPO3_CONF_VARS['EXTCONF']['comments']['processValidComment'][$_EXTKEY] = 'EXT:' . $_EXTKEY . '/hooks/class.tx_t3orgcomments_hooks.php:&tx_t3orgcomments_hooks->processValidComment';
...
$TYPO3_CONF_VARS['EXTCONF']['comments']['comments'][$_EXTKEY] = 'EXT:' . $_EXTKEY . '/hooks/class.tx_t3orgcomments_hooks.php:&tx_t3orgcomments_hooks->addCommentMarkers';
$TYPO3_CONF_VARS['EXTCONF']['comments']['form'][$_EXTKEY] = 'EXT:' . $_EXTKEY . '/hooks/class.tx_t3orgcomments_hooks.php:&tx_t3orgcomments_hooks->addFormMarkers';
